...
strSQL = "SELECT semp_nm,dob,sdesgn,emp_cd,ppono,unit,contactno,aadhaarno FROM exgra_mas where len(trim(aadhaarno)) > 0"
...
<p align="center"><span class="style10"><font face="Arial"><strong>Aadhaar Updated Pensioners / Family Pensioners Details</strong></font></span><strong><font face="Arial"></font></strong></p>
<div align="center">
